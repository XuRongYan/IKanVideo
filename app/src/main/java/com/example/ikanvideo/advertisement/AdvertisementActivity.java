package com.example.ikanvideo.advertisement;
...
public class AdvertisementActivity extends BaseActivity {
    ...
    private void skip() {
        ...
        if (advVideo != null) {
            addDislike(user.getUserid(), advVideo.getVideoid());
        }
    ...
    private void addDislike(int userId, int videoId) {
        ApiService apiService = new ApiService();
        Observable<HttpResult> observable = apiService.getService(NetworkApi.class).addDisLike(userId, videoId);
        HttpUtil.getInstance().toSubscribe(observable, new ProgressSubscriber(this) {
            ...
            protected void _onError(String message) {
                LogUtils.e(TAG, "addDislike", message);
            }
