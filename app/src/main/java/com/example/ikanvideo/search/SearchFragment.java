package com.example.ikanvideo.search;
...
import com.example.ikanvideo.adapter.SearchResultAdapter;
...
//                        }
    ...
    private void handleList(List<Video> list) {
        for (Video video : list) {
            if (video.getTitle().contains("第1集")) {
                video.setTitle(video.getTitle().replace("第1集", ""));
                LogUtils.e(TAG_LOG, "handleList", "改变了标题：" + video.getTitle());
            } else if (video.getTitle().contains("第一集")) {
                video.setTitle(video.getTitle().replace("第一集", ""));
                LogUtils.e(TAG_LOG, "handleList", "改变了标题：" + video.getTitle());
            }
        }
    }
