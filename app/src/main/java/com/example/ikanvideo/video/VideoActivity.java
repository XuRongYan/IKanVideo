package com.example.ikanvideo.video;
...
import com.example.ikanvideo.adapter.PopGuessULikeAdapter;
import com.example.ikanvideo.widget.vitamioView.CustomMediaController;
...
public class VideoActivity extends BaseActivity implements MediaPlayer.OnInfoListener, MediaPlayer.OnBufferingUpdateListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (video.getStopPoint() != 0) {
            mVideoView.seekTo(video.getStopPoint());
        }
        timeLast = System.currentTimeMillis();
        startPoint = mVideoView.getCurrentPosition();
    ...
    protected void onPause() {
        ...
        super.onPause();
        stopPoint = mVideoView.getCurrentPosition();
    ...
    protected void onDestroy() {
        ...
        lastTimeFormat = TimeUtils.getTimeInSecond(timeLast);
    ...
    public void getVideoComment() {
        ...
        HttpUtil.getInstance().toSubscribe(videoCommentById, new ProgressSubscriber<List<Comment>>(this) {
            ...
            protected void _onNext(List<Comment> comments) {
                ...
                mCustomMediaController.addCommentsAndNotify(comments);
    ...
    private void addHistory() {
        ApiService apiService = new ApiService();
        Observable<HttpResult> observable = apiService.getService(NetworkApi.class).addHistory(user.getUserid(), video.getVideoid(), video.getTitle(), video.getTitlenew(), startPoint, stopPoint, timeLast);
